...
Maximum 1000 words, excluding tables, architecture diagram, screenshots, and references.

## 1. Overview

Briefly describe Aussie EcoLens and its purpose.
...
5. Query by tags or species.
6. Edit tags or delete media.
7. Subscribe to tag notifications.
