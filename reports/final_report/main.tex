...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=south east,align=right,text=EcoGreen] at ($(current page.south east)+(-1.6cm,1.5cm)$) {
    ...
    {\small Private source repository: shared with teaching team separately}
  };
...
Reports and repository & This PDF includes official icons, contribution table, testing guide, and source repository evidence. Detailed product manual and CI workflow are included in the repository. & Private repository access is shared with the teaching team separately.\\
\bottomrule
\end{tabularx}
\normalsize
